...
const YetkiliPersSearchModalGuncelle = ({ personelList,PersonelAd,currentEmployee,indexOfFirstEmployee,indexOfLastEmployee }) => {
    ...
    <>
    
     {
        personelList && personelList.length > 0 ?
                   ...
                   personelList.filter(per => {
                       return per.statuID !== "Personel"
                   }).sort((a,b) => (a.personelAd < b.personelAd ? -1 : 1))
...
export default YetkiliPersSearchModalGuncelle;