...
import SearchYetkiliOnay from './SearchTable/SearchYetkiliOnay';
//import Pagination from '../personel/Pagination/Pagination';
import Pagination from '@mui/material/Pagination';
import { TextField } from '@mui/material';

const YetkiliOnayDurum = (props) => {
 ...
 function search(){
    ...
    return (
        ...
        <div class="card p-1">
            ...
            <h5 className="card-title">Onaylanmış Talepler</h5>
...
<TextField id="filled-basic" label="Arama..." variant="filled" onChange={(e) => setQ(e.target.value)} />
            ...
            <table className="table mt-1 table-bordered">
                ...
                {/* {
                    ...
                    <SearchYetkiliOnay startDate={startDate} endDate={endDate} talepList={search(talepList)} indexOfLastEmployee={indexOfLastEmployee} indexOfFirstEmployee={indexOfFirstEmployee} PersonelAd={props.PersonelAd} />
...
export default YetkiliOnayDurum
