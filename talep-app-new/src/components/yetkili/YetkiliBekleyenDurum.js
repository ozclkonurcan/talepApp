...
import SearchYetkiliBekleyen from './SearchTable/SearchYetkiliBekleyen';
//import Pagination from '../personel/Pagination/Pagination';
import Pagination from '@mui/material/Pagination';
import { TextField } from '@mui/material';

const YetkiliBekleyenDurum = (props) => {
...
const totalPagesNum = Math.ceil(talepList.filter(tal => {
   return tal.personelID === props.PersonelAd && tal.talepDurum===0 //&&   tal.departmanID === perList.departmanID && tal.sirketID === perList.sirketID  &&tal.sektorID === perList.sektorID
 ...
 function search(){
    ...
    return (
        ...
        <div class="card p-1">
            ...
            <h5 className="card-title">Bekleyen Talepler</h5>
        ...
        return tal.personelID === props.PersonelAd && tal.talepDurum === 0
...
<TextField id="filled-basic" label="Arama..." variant="filled" onChange={(e) => setQ(e.target.value)} />
            ...
            <table className="table mt-1 table-bordered">
                ...
                {/* {
                    ...
                    <SearchYetkiliBekleyen startDate={startDate} endDate={endDate} talepList={search(talepList)} indexOfLastEmployee={indexOfLastEmployee} indexOfFirstEmployee={indexOfFirstEmployee} PersonelAd={props.PersonelAd} />
...
export default YetkiliBekleyenDurum
