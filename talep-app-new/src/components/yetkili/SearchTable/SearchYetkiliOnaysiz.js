...
const SearchYetkiliOnaysiz = ({startDate,endDate, tal, talepList,PersonelAd,currentEmployee,indexOfFirstEmployee,indexOfLastEmployee }) => {
    ...
    <>
    
     {
                    ...
                    talepList.sort((a,b) => (a.onayTarih > b.onayTarih ? -1 : 1)).filter(tal => {
                        ...
                        || tal.talepTarih === startDate && tal.talepDurum === 2 && tal.personelID == PersonelAd
...
export default SearchYetkiliOnaysiz;