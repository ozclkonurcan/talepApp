...
import SearchModalOnay from './SearchTable/SearchModalOnay'
import { Alert, Stack } from 'react-bootstrap';
import { textAlign } from '@mui/system';
import { TextField } from '@mui/material';


const YetkiliPersonelOnaylama = (props) => {
...
<h5 className="card-title">Personel işlem</h5>
...
export default YetkiliPersonelOnaylama
