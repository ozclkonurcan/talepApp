...
import SearchBekleyenOnay from '../SearchTable/SearchBekleyenOnay';
...
const BekleyenOnayPersonel = (props) => {
...
<h5 class="card-title">Personel Talep Durum İnceleme</h5>
...
</Stack>           {/* <input type="text" value={q} className="search form-control" placeholder="Arama..." /> */}
                </div>
...
<table className="table mt-1 table-bordered">
  ...
  {/* {
      ...
      <SearchBekleyenOnay startDate={startDate} endDate={endDate} talepList={search(talepList)} indexOfLastEmployee={indexOfLastEmployee} indexOfFirstEmployee={indexOfFirstEmployee} PersonelAd={props.PersonelAd} />
...
export default BekleyenOnayPersonel;
