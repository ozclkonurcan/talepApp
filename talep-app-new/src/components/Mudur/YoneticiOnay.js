...
import SearchYoneticiOnay from './Search/SearchYoneticiOnay';
...
<h5 className="card-title">Personel Talep Listesi</h5>
...
<TextField id="filled-basic" label="Arama..." variant="filled" onChange={(e) => setQ(e.target.value.toLowerCase())} />
            ...
            <table className="table mt-1 table-bordered">
                ...
                <tbody>
                    ...
                    <SearchYoneticiOnay  startDate={startDate} endDate={endDate} talepList={search(talepList)} PersonelResim={props.PersonelResim} PersonelID={props.PersonelID} indexOfLastEmployee={indexOfLastEmployee} indexOfFirstEmployee={indexOfFirstEmployee} PersonelAd={props.PersonelAd} />
