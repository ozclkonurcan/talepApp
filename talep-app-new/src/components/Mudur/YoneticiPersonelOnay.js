...
import SearchModalOnay from './Search/SearchModalPers'
import { Alert, Stack } from 'react-bootstrap';
import Pagination from '@mui/material/Pagination';
import { TextField } from '@mui/material';

const YoneticiPersonelOnay = (props) => {
...
const totalPagesNum = Math.ceil(talepList.filter(tal => {
   return tal.personelID !== props.PersonelAd && tal.talepDurum===0 && tal.personelStatuID===1 && tal.talepTahminiDeger > 1000
 ...
 function search(){
    ...
    return (
        ...
        <div class="card p-1">
            ...
            <h5 className="card-title">Personel İşlemleri</h5>
        ...
        return tal.personelID !== props.PersonelAd && tal.talepDurum === 0 && tal.personelStatuID===1 && tal.talepTahminiDeger > 10000
        &&   perList.some(per => per.sektorID === tal.sektorID && per.sirketID === tal.sirketID && per.departmanID === tal.departmanID)
...
<TextField id="filled-basic" label="Arama..." variant="filled" onChange={(e) => setQ(e.target.value.toLowerCase())} />
            ...
            <table className="table mt-1 table-bordered">
                ...
                {/* {
                    ...
                    <SearchModalOnay startDate={startDate} endDate={endDate} talepList={search(talepList)} indexOfLastEmployee={indexOfLastEmployee} indexOfFirstEmployee={indexOfFirstEmployee} PersonelResim={props.PersonelResim} PersonelID={props.PersonelID} PersonelAd={props.PersonelAd} />
...
export default YoneticiPersonelOnay
