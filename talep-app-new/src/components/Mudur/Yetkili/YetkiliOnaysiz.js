...
import SearchYoneticiOnay from '../Yetkili/search/SearchOnaysız';
...
const totalPagesNum = Math.ceil(talepList.filter(tal => {
   return tal.personelID !== props.PersonelAd && tal.talepDurum===2 && tal.personelStatuID ===2 
 ...
 function search(){
    ...
    return (
        ...
        <div class="card p-1">
            ...
            <h5 className="card-title">Yetkili Onaylanmamış Talepler</h5>
