...
import SearchYoneticiOnay from '../Yetkili/search/SearchOnaylı';
...
const totalPagesNum = Math.ceil(talepList.filter(tal => {
   return tal.personelID !== props.PersonelAd && tal.talepDurum=== 1 && tal.personelStatuID ===2 
 ...
 function search(){
    ...
    return (
        ...
        <div class="card p-1">
            ...
            <h5 className="card-title">Yetkili Onaylanmış Talepler</h5>
