...
import SearchYoneticiOnay from '../Personel/search/SearchOnaysız';
//import Pagination from '../../personel/Pagination/Pagination';
import Pagination from '@mui/material/Pagination';
import { TextField } from '@mui/material';

const PersonelOnaysiz = (props) => {
...
const totalPagesNum = Math.ceil(talepList.filter(tal => {
   return tal.personelID !== props.PersonelAd && tal.talepDurum === 2  && tal.personelStatuID === 1 //&& tal.talepTahminiDeger >= 10000
 ...
 function search(){
    ...
    return (
        ...
        return tal.personelID !== props.PersonelAd && tal.talepDurum === 2 && tal.personelStatuID===1
        &&   perList.some(per => per.sektorID === tal.sektorID && per.sirketID === tal.sirketID && per.departmanID === tal.departmanID)
...
export default PersonelOnaysiz
